...
function createMarkDown(e) {
 ...
 if(userFeedbackValue && !isEditMode) {
   ...
   createUserFeedbackList(List, userFeedbackValue);
...
function createUserFeedbackList(text) {
 ...
 editWrapper.classList.add('editWrapper');
  ...
  editBtn.innerHTML = `<img src="https://raw.githubusercontent.com/Dinesh1042/Vanilla-JavaScript-Projects/b3d61299b60bf30a93c1d50bba9c25597db74003/Markdown%20Maker/asset/edit.svg" alt="edit-icon" />`;
